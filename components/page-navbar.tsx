...
export function MainNav({ items, children }: NavProps) {
 ...
 export function MobileNav({ items, children}: NavProps) {
    ...
    return (
      ...
      <div className="relative h-full z-20 rounded-xl bg-popover p-4 text-popover-foreground backdrop-blur-md border-gray-900 dark:border-gray-200 border-2 bottom-0">
